  ...
  return (
    <nav className="p-4 text-white text-center">
        <ul class="space-y-8 sm:flex sm:justify-center sm:space-x-12 sm:space-y-0">
            ...
            <li class="cursor-pointer text-3xl hover:text-black"><a href="/contact">Contact</a></li>
            <li class="cursor-pointer text-3xl hover:text-black"><a href="/catalogue">Catalogue</a></li>
        </ul>
    </nav>
  )
}

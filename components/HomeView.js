...
const HomeView = () => {
  return (
    <div className="m-auto h-fit w-fit text-center md:text-left text-black">
        ...
        <h1 className="font-extrabold text-6xl lg:text-7xl xl:text-9xl py-5"><span className='text-red-600 shadow-white'>American </span><span className="xl:text-white shadow-black">Tourister</span></h1>
